  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className="text">Опишите продукцию или загрузите таблицу для анализа</h1>
        <div className="group_info">
          ...
          <div className="trebovania">
            ...
            <p>Скачайте файл-шаблон и заполните строки данными о товарах по правилам:</p>
            <p>Не вносите изменения в названия столбцов
            Текст
            текст
            текст
            текст</p>
